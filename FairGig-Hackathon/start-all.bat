...
:: Start Node.js Grievance Service (Port 3001) - MVC
echo [1/4] Starting Grievance Service (Port 3001)...
cd /d C:\Users\OK\Desktop\Competition\FairGig-Hackathon\fairgig-node
start "Grievance Service (3001)" cmd /k "node server.js"

timeout /t 2 /nobreak > nul

:: Start Python Auth Service (Port 8000) - OLD monolithic
echo [2/4] Starting Auth & Earnings Service (Port 8000)...
cd /d C:\Users\OK\Desktop\Competition\FairGig-Hackathon\fairgig-python
start "Auth Service (8000)" cmd /k "venv\Scripts\activate && python main.py"

timeout /t 2 /nobreak > nul

:: Start Python Anomaly Service (Port 8001) - OLD monolithic
...
cd /d C:\Users\OK\Desktop\Competition\FairGig-Hackathon\certificate-service
